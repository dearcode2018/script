 ...
 * BatchScriptTest
 */
public final class BatchScriptTest extends BaseTest {
	...
	public void testJavaCallBat() {
		try {
			...
			/* 在 start 添加双引号之后，就可以在bat执行完毕之后直接关闭窗口 */
	...
	public void testOpenDirectory() {
		try {
			String command = "cmd /c start D:\\workspace\\java";
			final Runtime rt = Runtime.getRuntime();
			Process ps = rt.exec(command);
			
		} catch (Exception e) {
			log.error("testOpenDirectory =====> ", e);
		}
	}	
